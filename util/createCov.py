            ...
            for i in range(0,2+ex1):
                        for j in range(0,2+ex2):
                                    ...
                                    if os.path.isfile(BASE_INI_AND_BATCH+'/'+base+'_'+gvec[j]+svec[i]+'.ini') :
                                                ...
                                                h.write('timeout 126000 mpirun /project/rkessler/PRODUCTS/CosmoMC/v03/CosmoMC-master/cosmomc '+file_root+'_'+gvec[j]+svec[i]+'_'+str(int(datasetnum))+'.ini\n')
...
if __name__ == "__main__":
  ...
  if not FileInfo.ROOTDIR: print('no ROOTDIR making it /scratch/midway/rkessler/djbrout/cosmomc/chains2/'); FileInfo.ROOTDIR='/scratch/midway/rkessler/djbrout/cosmomc/chains2/'
